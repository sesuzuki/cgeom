...
{
    public class PerFaceNormalsGH : GH_Component
    {
        /// <summary>
        ...
        {
            pManager.AddVectorParameter("Normals", "Normals", "Per face normals", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Vector3d[] n = DiscreteQuantities.PerFaceNormals(m);
        ...
        {
            get { return new Guid("95ce00a8-48f8-482b-a2ba-a0b2849bc2c9"); }
        }
    }
}
