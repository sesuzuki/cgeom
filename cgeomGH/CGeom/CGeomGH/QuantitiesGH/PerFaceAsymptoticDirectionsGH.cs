...
namespace CGeomGH.QuantitiesGH
{
    public class PerFaceAsymptoticDirectionsGH : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("I", "I", "Indexes of faces where asymptotic directions vanish.", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Vector3d[] dir1, dir2;
            int[] idx;
            DiscreteQuantities.PerFaceAsymptoticDirections(m, out dir1, out dir2, out idx);
